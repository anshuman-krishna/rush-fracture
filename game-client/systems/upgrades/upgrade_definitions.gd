...
static var catalog: Array[Dictionary] = [
	...
	# phase 14 — build diversity
	{
		"type": UpgradeType.RICOCHET_ROUNDS,
		"name": "ricochet rounds",
		"description": "rifle shots bounce to a nearby enemy",
		"stat": "ricochet_rounds",
		"modifier": 1.0,
		"apply_mode": "special",
		"weapon_type": "pulse_rifle",
	},
	{
		"type": UpgradeType.PIERCING_BEAM,
		"name": "piercing beam",
		"description": "beam passes through enemies",
		"stat": "piercing_beam",
		"modifier": 1.0,
		"apply_mode": "special",
		"weapon_type": "beam_emitter",
	...
	{
		"type": UpgradeType.EXPLOSIVE_DASH,
		"name": "explosive dash",
		"description": "dashing creates a shockwave that damages nearby enemies",
		"stat": "explosive_dash",
		"modifier": 1.0,
		"apply_mode": "special",
	},
